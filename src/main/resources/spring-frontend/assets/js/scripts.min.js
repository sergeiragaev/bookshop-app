            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/rating/rateBookReview/' + $this.data('bookid') +
                            '/' + data.reviewid + '?value=' + data.value, data, function (result) {
                            if (result != null && result.result) {
                                ...
                                $this.find('.btn-content').addClass('form-input_error').after('<div class="form-error">' + 'Ошибка!' + '</div>');
                                $("#err_dialog").dialog();
                            }
                        });
                    });
                ...
                $.ajax({
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            ...
                            alert('Ошибка: ' + result.responseJSON.error);
                            if (cbErr) {
                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result) {
                                        ...
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div class="form-error">'
                                            + 'Wrong code or phone number!' + '</div>');
                                    } else {
            ...
            return {
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        } else if ($this.data('sendstatus') === 'UNLINK'){
                            Login().postData($this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if ($this.is('[data-btntype="check"]')) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/rating/changeBookStatus/'  + $this.data('bookid') + '?value=' + $this.val(), {
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                            getData(address, {
                                                offset: function (){
                                                    var oldOffest = $(slick.$slider).data('loadoffset');
                                                    $(slick.$slider).data('loadoffset', ++oldOffest);
